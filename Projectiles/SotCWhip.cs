...
{
    public class SotCWhip : ModProjectile
    {
        // The folder path to the flail chain sprite
        private const string ChainTexturePath = "FE3H/Projectiles/Whip";

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("SotC Whip"); // Set the projectile name to Example Flail Ball
        }
        ...
        public override void AI()
        {
            ...
            else if (projectile.ai[0] == 1f)
            {
                ...
                float elasticFactorA = 30f / player.meleeSpeed;
                float elasticFactorB = 10f / player.meleeSpeed;
                float maxStretchLength = 1000f; // This is the furthest the flail can stretch before being forced to retract. Make sure that this is a bit less than maxChainLength so you don't accidentally reach maxStretchLength on the initial throw.
